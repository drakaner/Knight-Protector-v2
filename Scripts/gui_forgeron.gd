...
func _ready() -> void:
	...
	gui_bague1.resize(21)
	gui_bague2.resize(21)
	gui_bague3.resize(21)
	gui_bottes1.resize(21)
	gui_bottes2.resize(21)
	gui_bottes3.resize(21)
	gui_bottes4.resize(21)
	gui_bottes5.resize(21)
	gui_bottes6.resize(21)
	gui_bouclier1.resize(21)
	gui_bouclier2.resize(21)
	gui_bouclier3.resize(21)
	gui_bouclier4.resize(21)
	gui_bouclier5.resize(21)
	gui_bouclier6.resize(21)
	gui_bouclier7.resize(21)
	gui_casque1.resize(21)
	gui_casque2.resize(21)
	gui_casque3.resize(21)
	gui_casque4.resize(21)
	gui_casque5.resize(21)
	gui_casque6.resize(21)
	gui_collier1.resize(21)
	gui_collier2.resize(21)
	gui_collier3.resize(21)
	gui_heaume1.resize(21)
	gui_heaume2.resize(21)
	gui_heaume3.resize(21)
	gui_heaume4.resize(21)
	gui_heaume5.resize(21)
	gui_heaume6.resize(21)
	gui_sword1.resize(21)
	gui_sword2.resize(21)
	gui_sword3.resize(21)
	gui_sword4.resize(21)
	gui_sword5.resize(21)
	gui_sword6.resize(21)
	gui_sword7.resize(21)
	gui_sword8.resize(21)
...
func update_inventaires_visibility():
	for bague in gui_bague1:
		if bague != null:
			bague.visible = true
	
	for bague in gui_bague2:
		if bague != null:
			bague.visible = true
	
	for bague in gui_bague3:
		if bague != null:
			bague.visible = true
	
	for bottes in gui_bottes1:
		if bottes != null:
			bottes.visible = true
	
	for bottes in gui_bottes2:
		if bottes != null:
			bottes.visible = true
	
	for bottes in gui_bottes3:
		if bottes != null:
			bottes.visible = true
	
	for bottes in gui_bottes4:
		if bottes != null:
			bottes.visible = true
	
	for bottes in gui_bottes5:
		if bottes != null:
			bottes.visible = true
	
	for bottes in gui_bottes6:
		if bottes != null:
			bottes.visible = true
	
	for bouclier in gui_bouclier1:
		if bouclier != null:
			bouclier.visible = true
	
	for bouclier in gui_bouclier2:
		if bouclier != null:
			bouclier.visible = true
	
	for bouclier in gui_bouclier3:
		if bouclier != null:
			bouclier.visible = true
	
	for bouclier in gui_bouclier4:
		if bouclier != null:
			bouclier.visible = true
	
	for bouclier in gui_bouclier5:
		if bouclier != null:
			bouclier.visible = true
	
	for bouclier in gui_bouclier6:
		if bouclier != null:
			bouclier.visible = true
	
	for bouclier in gui_bouclier7:
		if bouclier != null:
			bouclier.visible = true
	
	for casque in gui_casque1:
		if casque != null:
			casque.visible = true
	
	for casque in gui_casque2:
		if casque != null:
			casque.visible = true
	
	for casque in gui_casque3:
		if casque != null:
			casque.visible = true
	
	for casque in gui_casque4:
		if casque != null:
			casque.visible = true
	
	for casque in gui_casque5:
		if casque != null:
			casque.visible = true
	
	for casque in gui_casque6:
		if casque != null:
			casque.visible = true
	
	for collier in gui_collier1:
		if collier != null:
			collier.visible = true
	
	for collier in gui_collier2:
		if collier != null:
			collier.visible = true
	
	for collier in gui_collier3:
		if collier != null:
			collier.visible = true
	
	for heaume in gui_heaume1:
		if heaume != null:
			heaume.visible = true
	
	for heaume in gui_heaume2:
		if heaume != null:
			heaume.visible = true
	
	for heaume in gui_heaume3:
		if heaume != null:
			heaume.visible = true
	
	for heaume in gui_heaume4:
		if heaume != null:
			heaume.visible = true
	
	for heaume in gui_heaume5:
		if heaume != null:
			heaume.visible = true
	
	for heaume in gui_heaume6:
		if heaume != null:
			heaume.visible = true
	
	for sword in gui_sword1:
		if sword != null:
			sword.visible = true
	
	for sword in gui_sword2:
		if sword != null:
			sword.visible = true
	
	for sword in gui_sword3:
		if sword != null:
			sword.visible = true
	
	for sword in gui_sword4:
		if sword != null:
			sword.visible = true
	
	for sword in gui_sword5:
		if sword != null:
			sword.visible = true
	
	for sword in gui_sword6:
		if sword != null:
			sword.visible = true
	
	for sword in gui_sword7:
		if sword != null:
			sword.visible = true
	
	for sword in gui_sword8:
		if sword != null:
			sword.visible = true
	...
	if nbPage == 1:
		for n in range(15, gui_bague1.size()):
			if gui_bague1[n] != null:
				...
				if lstIngredientsSelect.index1 != -1 and lstIngredientsSelect.item1 == "bague_1":
					gui_bague1[lstIngredientsSelect.index1].visible = true
				if lstIngredientsSelect.index2 != -1 and lstIngredientsSelect.item2 == "bague_1":
					gui_bague1[lstIngredientsSelect.index2].visible = true
	...
	for n in range(21):
		if isSlot_libre[n] == true:
			if DataSave.items_posession.bague1 != nbCompteurBague1 and txtItemType[n] == "vide":
				...
				gui_bague1[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bague2 != nbCompteurBague2 and txtItemType[n] == "vide":
				...
				gui_bague2[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bague3 != nbCompteurBague3 and txtItemType[n] == "vide":
				...
				gui_bague3[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bottes1 != nbCompteurBottes1 and txtItemType[n] == "vide":
				...
				gui_bottes1[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bottes2 != nbCompteurBottes2 and txtItemType[n] == "vide":
				...
				gui_bottes2[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bottes3 != nbCompteurBottes3 and txtItemType[n] == "vide":
				...
				gui_bottes3[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bottes4 != nbCompteurBottes4 and txtItemType[n] == "vide":
				...
				gui_bottes4[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bottes5 != nbCompteurBottes5 and txtItemType[n] == "vide":
				...
				gui_bottes5[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bottes6 != nbCompteurBottes6 and txtItemType[n] == "vide":
				...
				gui_bottes6[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bouclier1 != nbCompteurBouclier1 and txtItemType[n] == "vide":
				...
				gui_bouclier1[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bouclier2 != nbCompteurBouclier2 and txtItemType[n] == "vide":
				...
				gui_bouclier2[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bouclier3 != nbCompteurBouclier3 and txtItemType[n] == "vide":
				...
				gui_bouclier3[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bouclier4 != nbCompteurBouclier4 and txtItemType[n] == "vide":
				...
				gui_bouclier4[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bouclier5 != nbCompteurBouclier5 and txtItemType[n] == "vide":
				...
				gui_bouclier5[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bouclier6 != nbCompteurBouclier6 and txtItemType[n] == "vide":
				...
				gui_bouclier6[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.bouclier7 != nbCompteurBouclier7 and txtItemType[n] == "vide":
				...
				gui_bouclier7[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.casque1 != nbCompteurCasque1 and txtItemType[n] == "vide":
				...
				gui_casque1[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.casque2 != nbCompteurCasque2 and txtItemType[n] == "vide":
				...
				gui_casque2[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.casque3 != nbCompteurCasque3 and txtItemType[n] == "vide":
				...
				gui_casque3[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.casque4 != nbCompteurCasque4 and txtItemType[n] == "vide":
				...
				gui_casque4[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.casque5 != nbCompteurCasque5 and txtItemType[n] == "vide":
				...
				gui_casque5[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.casque6 != nbCompteurCasque6 and txtItemType[n] == "vide":
				...
				gui_casque6[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.collier1 != nbCompteurCollier1 and txtItemType[n] == "vide":
				...
				gui_collier1[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.collier2 != nbCompteurCollier2 and txtItemType[n] == "vide":
				...
				gui_collier2[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.collier3 != nbCompteurCollier3 and txtItemType[n] == "vide":
				...
				gui_collier3[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.heaume1 != nbCompteurHeaume1 and txtItemType[n] == "vide":
				...
				gui_heaume1[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.heaume2 != nbCompteurHeaume2 and txtItemType[n] == "vide":
				...
				gui_heaume2[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.heaume3 != nbCompteurHeaume3 and txtItemType[n] == "vide":
				...
				gui_heaume3[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.heaume4 != nbCompteurHeaume4 and txtItemType[n] == "vide":
				...
				gui_heaume4[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.heaume5 != nbCompteurHeaume5 and txtItemType[n] == "vide":
				...
				gui_heaume5[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.heaume6 != nbCompteurHeaume6 and txtItemType[n] == "vide":
				...
				gui_heaume6[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.sword1 != nbCompteurSword1 and txtItemType[n] == "vide":
				...
				gui_sword1[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.sword2 != nbCompteurSword2 and txtItemType[n] == "vide":
				...
				gui_sword2[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.sword3 != nbCompteurSword3 and txtItemType[n] == "vide":
				...
				gui_sword3[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.sword4 != nbCompteurSword4 and txtItemType[n] == "vide":
				...
				gui_sword4[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.sword5 != nbCompteurSword5 and txtItemType[n] == "vide":
				...
				gui_sword5[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.sword6 != nbCompteurSword6 and txtItemType[n] == "vide":
				...
				gui_sword6[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.sword7 != nbCompteurSword7 and txtItemType[n] == "vide":
				...
				gui_sword7[n].scale = Vector2(0.58, 0.68)
			...
			if DataSave.items_posession.sword8 != nbCompteurSword8 and txtItemType[n] == "vide":
				...
				gui_sword8[n].scale = Vector2(0.58, 0.68)
