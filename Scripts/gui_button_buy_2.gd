...
@onready var child_node = gui_button_buy.get_node("hud_button_6000")
...
func _on_hud_button_6000_gui_input(event: InputEvent) -> void:
	if Input.is_action_just_pressed("button_left"):
		child_node.modulate = Color(1, 1, 1, 1)
		print("bon la ca marche pour le button buy 6000 !!!!!")
		if DataSave.hero.gold >= 6000 and DataSave.nbTotalItemsEquipements < 14:
			DataSave.hero.gold -= 6000
